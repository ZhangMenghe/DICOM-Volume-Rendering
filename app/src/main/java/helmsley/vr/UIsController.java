...
//    public static native void JUIonDoubleTouch(int indicate, float x, float y);
//
//    public static native void JUIsetSwitches(int idx, boolean isSet);
//    public static native void JUIsetJavaUIStatus(int item, int id);
//    public static native void JUIsetParam(int idx, float value);
//
//    public static native boolean JUIgetOriginalChecked(int idx);
//    public static native float JUIgetOriginalValue(int idx);
