...
extern "C"{
    ...
    JUI_METHOD(void, JUIsetCLAHEOptionNative)(JNIEnv * env, jclass, jint);
    JUI_METHOD(void, JUIsetCLAHEVariableDeltaStepNative)(JNIEnv * env, jclass, jboolean, jint, jint);
    JUI_METHOD(void, JUIApplyCLAHEChanges)(JNIEnv * env, jclass);
    JUI_METHOD(void, JUIsetTraversalTargetNative)(JNIEnv * env, jclass, jint);
    JUI_METHOD(void, JUIsetRenderingMethodNative)(JNIEnv * env, jclass, jint);

    JUI_METHOD(void, JUIsetVolumePose)(JNIEnv * env, jclass, jbooleanArray, jfloatArray);
