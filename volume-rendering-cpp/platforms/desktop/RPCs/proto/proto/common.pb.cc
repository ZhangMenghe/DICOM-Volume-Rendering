...
static void InitDefaultsscc_info_Request_proto_2fcommon_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Request_proto_2fcommon_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Request_proto_2fcommon_2eproto}, {}};

static void InitDefaultsscc_info_commonResponse_proto_2fcommon_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_commonResponse_proto_2fcommon_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_commonResponse_proto_2fcommon_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto_2fcommon_2eproto[2];
...
const char descriptor_table_protodef_proto_2fcommon_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ponse\022\017\n\007success\030\001 \001(\010\022\017\n\007res_msg\030\002 \001(\tb"
  "\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_proto_2fcommon_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto_2fcommon_2eproto_sccs[2] = {
  &scc_info_Request_proto_2fcommon_2eproto.base,
  &scc_info_commonResponse_proto_2fcommon_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fcommon_2eproto = {
  false, false, descriptor_table_protodef_proto_2fcommon_2eproto, "proto/common.proto", 127,
  &descriptor_table_proto_2fcommon_2eproto_once, descriptor_table_proto_2fcommon_2eproto_sccs, descriptor_table_proto_2fcommon_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_proto_2fcommon_2eproto::offsets,
  file_level_metadata_proto_2fcommon_2eproto, 2, file_level_enum_descriptors_proto_2fcommon_2eproto, file_level_service_descriptors_proto_2fcommon_2eproto,
};
...
void Request::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Request_proto_2fcommon_2eproto.base);
  req_msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  client_id_ = 0;
}
...
void commonResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_commonResponse_proto_2fcommon_2eproto.base);
  res_msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  success_ = false;
}
