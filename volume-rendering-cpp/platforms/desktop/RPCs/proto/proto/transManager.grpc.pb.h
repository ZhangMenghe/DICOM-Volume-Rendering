...
#ifndef GRPC_proto_2ftransManager_2eproto__INCLUDED
#define GRPC_proto_2ftransManager_2eproto__INCLUDED
 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void getAvailableConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::configResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void getAvailableConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::configResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void getAvailableConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::configResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      ...
      virtual void exportConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::commonResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void exportConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::commonResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void exportConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::commonResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      ...
      virtual void getAvailableDatasets(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::datasetResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void getAvailableDatasets(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::datasetResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void getAvailableDatasets(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::datasetResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void getAvailableConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::configResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void getAvailableConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::configResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void getAvailableConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::configResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      ...
      void exportConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::commonResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void exportConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::commonResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void exportConfigs(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::commonResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      ...
      void getAvailableDatasets(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::datasetResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void getAvailableDatasets(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::datasetResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void getAvailableDatasets(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helmsley::datasetResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  class ExperimentalWithCallbackMethod_getAvailableConfigs : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_getAvailableConfigs() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::Request, ::helmsley::configResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::Request, ::helmsley::configResponse>*>(handler)
  ...
  class ExperimentalWithCallbackMethod_getAvailableDatasets : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_getAvailableDatasets() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(2,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::Request, ::helmsley::datasetResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::Request, ::helmsley::datasetResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    ExperimentalWithCallbackMethod_getVolumeFromDataset() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(3,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::Request, ::helmsley::volumeResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    ExperimentalWithCallbackMethod_Download() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(4,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::Request, ::helmsley::dcmImage>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    ExperimentalWithCallbackMethod_DownloadVolume() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(5,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::helmsley::RequestWholeVolume, ::helmsley::volumeWholeResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    ExperimentalWithCallbackMethod_DownloadMasksVolume() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(7,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::Request, ::helmsley::volumeWholeResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
...
#endif  // GRPC_proto_2ftransManager_2eproto__INCLUDED
